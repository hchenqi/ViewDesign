...
inline void TransitionImageLayout(vk::raii::CommandBuffer& command_buffer, vk::Image image, vk::ImageLayout& image_layout, vk::ImageLayout image_layout_new, vk::ImageAspectFlags aspect = vk::ImageAspectFlagBits::eColor) {
	...
	static auto GetAccessAndStage = [](vk::ImageLayout layout) -> std::pair<vk::AccessFlags, vk::PipelineStageFlags> {
		...
		case vk::ImageLayout::eDepthAttachmentOptimal: return { vk::AccessFlagBits::eDepthStencilAttachmentRead | vk::AccessFlagBits::eDepthStencilAttachmentWrite, vk::PipelineStageFlagBits::eEarlyFragmentTests };
	...
	command_buffer.pipelineBarrier(src_stage, dst_stage, {}, {}, {}, vk::ImageMemoryBarrier(src_access, dst_access, image_layout, image_layout_new, vk::QueueFamilyIgnored, vk::QueueFamilyIgnored, image, vk::ImageSubresourceRange(aspect, 0, 1, 0, 1)));
